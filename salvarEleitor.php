<?php
	...
	$tipo 		= $_POST['tipo'];
	$filho 		= $_POST['filho'];
	$endereco	=  mysql_real_escape_string_quote($_POST['endereco']);
	$numero 	= $_POST['numero'];
	$bairro 	= $_POST['bairro'];
	$complemento 	=  mysql_real_escape_string_quote($_POST['complemento']);
	$cidade 	= $_POST['cidade'];
	$estado 	= $_POST['estado'];
	$regiao 	= $_POST['regiao'];
	...
	$ssql = "INSERT INTO Cliente (Nome, Titulo, Zona, Secao, Sexo, Tipo, Aniversario, Filho, Data, Negra, Cod_Prestador) VALUES ('$nome','$titulo','$zona','$secao','$sexo','$tipo','$aniversario','$filho','$data', 0, 1)";
