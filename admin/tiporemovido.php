<?php
    ...
    if ($ativo == 1){
        $ssql4 = "UPDATE Tipo SET Ativo = 0 WHERE Cod_Tipo = $codigo";
    }
    else {
        $ssql4 = "UPDATE Tipo SET Ativo = 1 WHERE Cod_Tipo = $codigo";
    }
    ...
    $texto = "<h2 align='center'>Tipo Atualizado com Sucesso</h2>
             <a href='getTipo.php' class='button round'>OK</a>";
