<?php
    ...
    if(isset($_POST['Submit'])){
        ...
        $sql = "INSERT INTO Prestador (Prestador, Ativo) VALUES ('$prestador', '1')";

        $DB->query($sql);
	    $DB->execute();
        redirect('getPrestador.php');
    }
?>
...
<html class="no-js" lang="en" > 
    ...
    <body>
        ...
        <h2 align='center'>Adicionar Prestador</h2>

        <div class="row">
		<div class="small-12 column">
			<form data-abide action="<?php echo $_SERVER['PHP_SELF'];?>" method="post" name="addPrestadorForm">
				<div class="name-field">
					<label> Prestador <small> *</small>
						<input required pattern="[a-zA-Z]+" type="text" placeholder="Prestador" name="prestador"/>
					</label>
					<small class="error">Prestador Obrigatório e somente Letras</small>
				</div>
                <div class="name-field">
				...
				<a class="button tiny round secondary" href="getPrestador.php">Cancelar</a>
            </form>
        </div>
        </div>
