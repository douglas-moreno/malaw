<?php
    ...
    if (isset($_GET['codcli'])) {
        ...
        // Prestador Principal
        $sqlPP = "Select * FROM Prestador where Codigo_Prestador =" . $linhacli['Cod_Prestador'];
        $queryPP = $DB->Query($sqlPP);
        $linhaPP = $DB->FetchArray($queryPP);
                        ...
                        <fieldset>
                            ...
                            <?php
                                ...
                                if($_SESSION['Admin'] == 1) {
                                    ...
                                    $queryPrestador = $DB->Query($sqlPrestador);
                                    echo "<select id='pp' name='pp'>";
                                    echo "<option value='1'>Não Selecionado</option>";
                                    while ($linhatpp = $DB->FetchArray($queryPrestador)) {
                                        if ($linhatpp["Codigo_Prestador"] == $linhaPP['Codigo_Prestador']) {
                                            echo "<option selected value='".$linhatpp["Codigo_Prestador"]."'>".$linhatpp["Prestador"]."</option>";
                                        }
                                        else {
                                            echo "<option value='".$linhatpp["Codigo_Prestador"]."'>".$linhatpp["Prestador"]."</option>";
                                        }
                                    }
                                    echo "</select>";
                                }
                                else {
                                    echo $linhaPP["Prestador"];
                                }
                                echo "</div></div></div>";
                            ?>
                            <div class="row">
