...
<body> 
	...
	<div class="row">
    	...
    	<div class="row">
    		...
    		<div class="panel">
		    <h2 align='center'>Editar Serviço</h2>
                    <form id="formserv" action="editarservicosalvar.php" method='post'>
                        <div class="row">
                            <div class="medium-1 columns">
                                <label>Tipo</label>
                            </div>
                            <div class="medium-11 columns">
                                <?php 
                                    ...
                                    echo "<input type='text' name='ntipo' disabled value='".$linha["Tipo"]."'/>";
                                ?>
                            </div>
                            <div class="medium-1 columns">
                            ...
                            <div class="medium-11 columns">
                                <?php echo "<textarea rows='6' name='ndesc'>".$linha["Descricao"]."</textarea>";?>
                            </div>
                            <div class="medium-1 columns">
                                <label>Prestador</label>
                            </div>
                            <div class="medium-11 columns">
                                <?php echo "<input type=\"text\" disabled name='nprestador' value='".$linha["Prestador"]."'/>";?>
                            </div>
                            <div class="row">
                                <div class="medium-12 columns">
                                    <?php 
