<?php
	...
	$obs 		= $_POST['obs'];
        ...
        $ssql = "UPDATE Cliente SET Nome='$nome', Negra='$negra', Titulo='$titulo', Zona='$zona', Secao='$secao', Sexo='$sexo', Tipo='$tipo', Aniversario='$aniversario', Filho='$filho' WHERE Cod_Cliente=$codigo";
